...
const ProjectList = () => {
    ...
    return (
        <div className='relative px-5 lg:px-0 lg:flex gap-5 justify-center py-5'>
            <section className='filterSection lg:w-1/4'>
                            ...
                            <div>
                                ...
                                <div className='pt-5'>
                                    <RadioGroup
                                        ...
                                        defaultValue="all"
                                        onValueChange={(value) => handlerFilterCategory(value)}
                                    >
                            ...
                            <div className='pt-9'>
                                ...
                                <div className='pt-5'>
                                    <RadioGroup
                                        className="space-y-3 pt-5"
                                        defaultValue="all"
                                        onValueChange={(value) => handlerFilterTags(value)}
                                    >
                                        {tags.map((item) => (
            ...
            <section className='projectListSection w-full lg:w-[40rem]'>
